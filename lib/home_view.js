...
export const homeEventListeners = () => {
  ...
  $('.recipe_lists').on('click', '.list-delete', function() {
...
function findListRecipes() {
  let ingredients = $(this).closest(".userlist").find('h6')
  let ingredients_array = Object.keys(ingredients).map(ings => ingredients[ings])
  let ingarray = []
